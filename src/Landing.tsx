...
const chefs: { nome: string; sub?: string; casa?: string; atracao: string; dia: string; cor: string; foto?: string; link?: string; instagram?: string; instagram2?: string; bio?: string; pronome?: string; status?: "aconfirmar" }[] = [
  { link: "/chefs/phelipe-carvalho", nome: "Chef Phelipe Carvalho", casa: "Curadoria gastronômica", atracao: "Embaixador São Luiz", dia: "", cor: "bg-telha", foto:"/chefs/phelipe-carvalho.webp", instagram: "https://www.instagram.com/phecarvalhopaduo/" },
  // SEXTA
  { link: "/chefs/georgia-santiago", pronome: "dela", nome: "Chef Georgia Santiago", casa: "Muá Tuá", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-oliva", foto: "/chefs/georgia-santiago.webp", instagram: "https://www.instagram.com/georgiasantiago/" },
  { nome: "Chef Daniel Sabbá", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-bordo", foto: "/chefs/daniel-sabba.webp", instagram: "https://instagram.com/danielsabba", link: "/chefs/daniel-sabba" },
  { link: "/chefs/chef-zena", pronome: "dela", nome: "Chef Zena", sub: "Sabores de uma bela História", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-vinho", foto: "/chefs/zena.webp", instagram: "https://www.instagram.com/restaurante.zena/" },
  { nome: "Chef Claude Troisgros", casa: "São Luiz", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-vinho", foto: "/chefs/claude-troisgros.webp", link: "/chefs/claude-troisgros", instagram: "https://www.instagram.com/c_troisgros/?hl=pt" },
  { nome: "Chef Brunno Malheiros", casa: "Cheiro do Pão", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-oliva", foto: "/chefs/brunno-malheiros.webp", link: "/chefs/brunno-malheiros", instagram: "https://www.instagram.com/brunnopadeiro/" },
  { link: "/chefs/edil-costa", nome: "Chef Edil Costa", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-[#8a3d18]", foto: "/chefs/edil-costa.webp", instagram: "https://www.instagram.com/edilcostaoficial/" },
  ...
  { link: "/chefs/marbenia", pronome: "dela", nome: "Marbenia Gonçalves", atracao: "Piano Bar", dia: "SEX", cor: "bg-vinho", foto: "/chefs/marbenia.webp", instagram: "https://www.instagram.com/marbenia/" },
  { link: "/chefs/leiliane", pronome: "dela", nome: "Leiliane Pinheiro", casa: "Wineladies", atracao: "Piano Bar", dia: "SEX", cor: "bg-oliva", foto: "/chefs/leiliane.webp", instagram: "https://www.instagram.com/leilianepinheiro/" },
  ...
  { link: "/chefs/beatriz-marcondes", pronome: "dela", nome: "Beatriz Marcondes", casa: "Rémy Cointreau", atracao: "Piano Bar", dia: "SEX", cor: "bg-oliva", foto: "/chefs/beatriz-marcondes.webp", instagram: "https://www.instagram.com/befernandesm" },
  { link: "/chefs/alex-yuji", nome: "Alex Yuji", casa: "Pernod Ricard", atracao: "Piano Bar", dia: "SEX", cor: "bg-bordo", foto: "/chefs/alex-yuji.png", instagram: "https://www.instagram.com/yujialexmix/" },
  // { nome: "Jardenia", casa: "D'Origem", atracao: "Piano Bar", dia: "SEX", cor: "bg-vinho", foto: "/chefs/jardenia.webp" },
  { link: "/chefs/izabela-fiuza", pronome: "dela", nome: "Chef Izabela Fiúza", casa: "La Maison · São Luiz", atracao: "Recebendo em Casa", dia: "SEX", cor: "bg-oliva", foto: "/chefs/isabela-fiuza.webp", instagram: "https://www.instagram.com/izabelafiuza/" },
  { link: "/chefs/bia-araujo", pronome: "dela", nome: "Chef Bia Araújo", atracao: "Recebendo em Casa", dia: "SEX", cor: "bg-vinho", foto: "/chefs/bia-araujo.webp", instagram: "https://www.instagram.com/beatricearaujo/" },
  { link: "/chefs/mona", pronome: "dela", nome: "Chef Mona", casa: "Netas de Olga", atracao: "Recebendo em Casa", dia: "SEX", cor: "bg-bordo", foto: "/chefs/mona.webp", instagram: "https://www.instagram.com/asnetasdeolga/" },
  { link: "/chefs/joao-filho", nome: "João Filho", sub: "Sommelier", atracao: "Piano Bar", dia: "SEX", cor: "bg-[#8a3d18]", foto: "/chefs/joao-filho.webp", instagram: "https://www.instagram.com/joaofilhosommelier/" },
  // SÁBADO
  { link: "/chefs/matu-macedo", pronome: "dela", nome: "Chef Mattu Macêdo", sub: "Sabor de uma bela história", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-vinho", foto: "/chefs/matu-macedo.webp", instagram: "https://www.instagram.com/mattumacedo/" },
  { nome: "Chef Felipe Caputo", casa: "São Luiz", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-vinho", foto: "/chefs/felipe-caputo.webp", instagram: "https://instagram.com/felipecaputo", link: "/chefs/felipe-caputo" },
  { nome: "Chef Thales Romão", casa: "NOM · Molino Padaria Artesanal", atracao: "Palco Gourmet", dia: "SEX", cor: "bg-[#8a3d18]", foto: "/chefs/thales-romao.webp", instagram: "https://instagram.com/thalesromao_", link: "/chefs/thales-romao" },
  { link: "/chefs/ralfo", nome: "Chef Ralfo", casa: "Parrilleiro", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-bordo", foto: "/chefs/ralfo.webp", instagram: "https://www.instagram.com/chefralfo/" },
  { link: "/chefs/marco-frossard", nome: "Chef Marco Frossard", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-[#8a3d18]", foto: "/chefs/marco-frossard.webp", instagram: "https://www.instagram.com/chefmarcofrossard/" },
  { link: "/chefs/barbara-saunders", pronome: "dela", nome: "Chef Barbara Saunders e Leune", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-vinho", foto: "/chefs/barbara-saunders.webp", instagram: "https://www.instagram.com/barbarasaunders/" },
  ...
  { link: "/chefs/deuza-firmiano", pronome: "dela", nome: "Deuza Firmiano", casa: "Jack Daniel's", atracao: "Piano Bar", dia: "SAB", cor: "bg-bordo", foto: "/chefs/deuza-firmiano.webp", instagram: "https://www.instagram.com/deuzafirmiano/" },
  ...
  { link: "/chefs/luiz-de-franca", nome: "Chef Luiz de França", atracao: "Recebendo em Casa", dia: "SAB", cor: "bg-vinho", foto: "/chefs/luiz-de-franca.webp", instagram: "https://www.instagram.com/chef_luizdefranca/" },
  ...
  { link: "/chefs/dani-gondim", pronome: "dela", nome: "Chef Dani Gondim", atracao: "Recebendo em Casa", dia: "SAB", cor: "bg-bordo", foto: "/chefs/dani-gondim.webp", instagram: "https://www.instagram.com/dani.gondim_/" },
  { link: "/chefs/felipe-cicconato", nome: "Chef Felipe Cicconato", atracao: "Recebendo em Casa", dia: "SAB", cor: "bg-[#8a3d18]", foto: "/chefs/felipe-cicconato.webp", instagram: "https://www.instagram.com/felipecicconato/" },
  { link: "/chefs/frederico-jayme", nome: "Chef Frederico Jayme", atracao: "Recebendo em Casa", dia: "SAB", cor: "bg-vinho", foto: "/chefs/frederico-jayme.webp", instagram: "https://www.instagram.com/cheffredericojayme/" },
  // DOMINGO
  { link: "/chefs/matheus-vieira", nome: "Chef Matheus Vieira", casa: "Arroz Tio João", atracao: "Palco Gourmet", dia: "DOM", cor: "bg-oliva", foto: "/chefs/matheus-vieira.webp", instagram: "https://instagram.com/chefmatheusvieira" },
  { nome: "Chef Pepê", sub: "Pepê e Diego", atracao: "Palco Gourmet", dia: "DOM", cor: "bg-[#8a3d18]", foto: "/chefs/pepe.webp", link: "/chefs/pepe-e-diego", pronome: "deles", instagram: "https://www.instagram.com/pepemva/" },
  { nome: "Chef Diego", sub: "Pepê e Diego", atracao: "Palco Gourmet", dia: "DOM", cor: "bg-vinho", foto: "/chefs/diego.webp", link: "/chefs/pepe-e-diego", pronome: "deles", instagram: "https://www.instagram.com/_diegofreire/" },
  { link: "/chefs/elcio-e-bia-nagano", pronome: "deles", nome: "Chef Elcio e Bia Nagano", sub: "Oficina", atracao: "Palco Gourmet", dia: "DOM", cor: "bg-bordo", foto: "/chefs/elcio-e-bia-nagano.webp", instagram: "https://www.instagram.com/elcionagano/", instagram2: "https://www.instagram.com/bianagano/" },
  ...
  { link: "/chefs/rafael-kim", nome: "Chef Rafael Kim", atracao: "Palco Gourmet", dia: "DOM", cor: "bg-vinho", foto: "/chefs/rafael-kim.webp", instagram: "https://www.instagram.com/rafajykim/" },
  ...
  { link: "/chefs/marina-araujo", pronome: "dela", nome: "Chef Marina Araújo", atracao: "Recebendo em Casa", dia: "DOM", cor: "bg-oliva", foto: "/chefs/marina-araujo.webp", instagram: "https://www.instagram.com/marinaaraujo/" },
  { link: "/chefs/gabi-barreto", pronome: "dela", nome: "Chef Gabi Barreto", atracao: "Recebendo em Casa", dia: "DOM", cor: "bg-bordo", foto: "/chefs/gabi-barreto.webp", instagram: "https://www.instagram.com/gabibarretoa_/" },
  { link: "/chefs/renata", pronome: "dela", nome: "Chef Renata", casa: "", atracao: "Recebendo em Casa", dia: "DOM", cor: "bg-vinho", foto: "/chefs/renata-azucar.webp", instagram: "https://www.instagram.com/azucar.atelier/" },
  { link: "/chefs/lia-quindere", pronome: "dela", nome: "Chef Lia Quinderé", atracao: "Recebendo em Casa", dia: "DOM", cor: "bg-[#8a3d18]", foto: "/chefs/lia-quindere.webp", instagram: "https://www.instagram.com/liaquindere/" },
...
const gradeEspacos: { id: string; nome: string; icon: string; grade: { dia: string; slots: { h: string; o: string; nota?: string; subtitulo?: string; patrocinadorLogo?: string | string[]; tema?: string; receita?: string; status: "confirmado" | "aconfirmar" | "fixo" | "intervalo" }[] }[] }[] = [
  ...
  { id: "piano", nome: "Piano Bar", icon: "wine", grade: [
    { dia: "Sexta", slots: [
      ...
      { h: "16h40 - 17h00", o: "Intervalo", status: "intervalo" },
      { h: "17h00 - 17h40", o: "Marbenia Gonçalves", nota: "São Luiz · Degustação", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", tema: "Marbênia Gonçalves, Head Sommelière, Wine Hunter e juíza de vinhos, convida você para uma vivência singular com fatos curiosos e histórias pitorescas de vinhos, revelados com sensibilidade e conhecimento de quem vive o vinho todos os dias. Mais do que uma degustação, uma descoberta. Venha descobrir o vinho além do rótulo.", status: "confirmado" },
      { h: "17h40 - 18h00", o: "Intervalo", status: "intervalo" },
      { h: "18h00 - 18h40", o: "Leiliane Pinheiro", nota: "São Luiz · Degustação", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", tema: "Eu não vendo vinho, eu vendo histórias! Vinho bom é aquele que rende boas histórias! Vamos brindar, conversar e degustar com Leiliane Pinheiro, sommelière e fundadora da Confraria Wineladies. Um encontro leve, descontraído e, claro, com bons vinhos para acompanhar.", status: "confirmado" },
      { h: "18h40 - 19h00", o: "Intervalo", status: "intervalo" },
      { h: "19h00 - 19h40", o: "Momento Chivas Regal por Alex Yuji", nota: "São Luiz · Degustação", patrocinadorLogo: ["/patrocinadores/premium-chivas.webp"], status: "confirmado" },
      { h: "19h40 - 20h00", o: "Intervalo", status: "intervalo" },
    ...
    { dia: "Sábado", slots: [
      { h: "15h00 - 16h00", o: "Piano", status: "fixo" },
      { h: "16h00 - 16h40", o: "Momento Chivas Regal com Alex Yuji + Fernanda Dantas", nota: "Spritz + Campari", patrocinadorLogo: "/patrocinadores/premium-chivas.webp", status: "confirmado" },
      { h: "16h40 - 17h00", o: "Intervalo", status: "intervalo" },
      { h: "17h00 - 17h40", o: "Carol Barreto", nota: "Santa Clara", patrocinadorLogo: "/patrocinadores/master-santa-clara.webp", status: "confirmado" },
      { h: "17h40 - 18h00", o: "Intervalo", status: "intervalo" },
      { h: "18h00 - 18h40", o: "Jack Daniel's | Deuza Firmiano", nota: "Deuza Firmiano", patrocinadorLogo: "/patrocinadores/logo-jackdaniels.webp", status: "confirmado" },
      { h: "18h40 - 19h00", o: "Intervalo", status: "intervalo" },
      ...
      { h: "19h40 - 20h00", o: "Intervalo", status: "intervalo" },
      { h: "20h00 - 20h40", o: "Momento Heineken por João Filho", patrocinadorLogo: "/patrocinadores/master-heineken.webp", status: "confirmado" },
      { h: "20h40 - 21h00", o: "Intervalo", status: "intervalo" },
    ...
    { dia: "Domingo", slots: [
      ...
      { h: "16h40 - 17h00", o: "Intervalo", status: "intervalo" },
      { h: "17h00 - 17h40", o: "Mauro Tirabosco", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", tema: "Do clássico ao surpreendente, uma experiência para quem aprecia bons sabores! Vamos mergulhar no fascinante mundo dos vermutes e do whisky japonês, conhecer e descobrir os detalhes por trás desses universos, com o mixologista Mauro Tirabosco. Prepare-se para descobrir, degustar e brindar novos sabores!", status: "confirmado" },
      { h: "17h40 - 18h00", o: "Intervalo", status: "intervalo" },
  ...
  { id: "casa", nome: "Recebendo em Casa", icon: "home", grade: [
    ...
    { dia: "Domingo", slots: [
      ...
      { h: "17h30 - 17h50", o: "Intervalo", status: "intervalo" },
      { h: "17h50 - 19h20", o: "Chef Gabi Barreto + Chef Renata Suarez + Jardenia Siqueira", nota: "Dorigem", patrocinadorLogo: "/patrocinadores/master-dorigem.webp", status: "confirmado" },
      { h: "19h20 - 19h40", o: "Intervalo", status: "intervalo" },
      { h: "19h40 - 22h00", o: "Chef Phelipe Carvalho + Chef Lia Quinderé", nota: "Phelipe Carvalho + Lia Quinderé · Pagueti + Dorigem", patrocinadorLogo: "/patrocinadores/logo-pagueti.webp", receita: "Entrada: amuse de queijo terroir Nossa Santa com prime rib.\nSobremesa: sopa de chocolate com Sucroc e Baniwa.", status: "confirmado" },
    ]},
  ]},
];
          ...
          <Reveal>
            <div className="mt-6 bg-oliva text-creme rounded-3xl p-7 md:p-8 md:flex items-center gap-8">
              ...
              <div className="mt-4 md:mt-0">
                ...
                <h3 className="font-serif font-bold text-xl mt-1">30 kits, 5 receitas escritas à mão pelo Phelipe Carvalho</h3>
