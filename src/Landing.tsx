...
const chefs: { nome: string; sub?: string; casa?: string; atracao: string; dia: string; cor: string; foto?: string; link?: string; instagram?: string; instagram2?: string; bio?: string; pronome?: string; status?: "aconfirmar" }[] = [
  ...
  { nome: "Edil Costa", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-[#8a3d18]", foto: "/chefs/edil-costa.webp", instagram: "https://www.instagram.com/edilcostaoficial/" },
  ...
  { nome: "João Filho", sub: "Sommelier", atracao: "Recebendo em Casa", dia: "SEX", cor: "bg-[#8a3d18]", foto: "/chefs/joao-filho.webp", instagram: "https://www.instagram.com/joaofilhosommelier/" },
  // SÁBADO
...
const gradeEspacos: { id: string; nome: string; icon: string; grade: { dia: string; slots: { h: string; o: string; nota?: string; subtitulo?: string; patrocinadorLogo?: string | string[]; status: "confirmado" | "aconfirmar" | "fixo" | "intervalo" }[] }[] }[] = [
  { id: "palco", nome: "Palco Gourmet", icon: "mic", grade: [
    { dia: "Sexta", slots: [
      ...
      { h: "21h00 - 21h40", o: "Thales Romão", nota: "NOM · Molino", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", status: "confirmado" },
    ...
    { dia: "Sábado", slots: [
      ...
      { h: "20h20 - 21h00", o: "Edil Costa", nota: "Le Cuiser · Netumar", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", status: "confirmado" },
  ...
  { id: "piano", nome: "Piano Bar", icon: "wine", grade: [
    { dia: "Sexta", slots: [
      ...
      { h: "16h00 - 16h40", o: "Maria Braz", nota: "São Luiz · Degustação", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", status: "confirmado" },
      { h: "16h40 - 17h00", o: "Intervalo", status: "intervalo" },
      { h: "17h00 - 17h40", o: "Marbenia", nota: "São Luiz · Degustação", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", status: "confirmado" },
      { h: "17h40 - 18h00", o: "Intervalo", status: "intervalo" },
