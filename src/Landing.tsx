...
const gradeEspacos: { id: string; nome: string; icon: string; grade: { dia: string; slots: { h: string; o: string; nota?: string; subtitulo?: string; patrocinadorLogo?: string | string[]; tema?: string; receita?: string; status: "confirmado" | "aconfirmar" | "fixo" | "intervalo" }[] }[] }[] = [
  ...
  { id: "casa", nome: "Recebendo em Casa", icon: "home", grade: [
    { dia: "Sexta", slots: [
      ...
      { h: "19h20 - 19h40", o: "Intervalo", status: "intervalo" },
      { h: "19h40 - 22h00", o: "Chef Phelipe Carvalho + Chef Mona Figueiredo ", nota: "Phelipe Carvalho + Mona · Opção", patrocinadorLogo: ["/patrocinadores/premium-netumar.webp", "/patrocinadores/master-opcao.webp"], status: "confirmado" },
    ]},
    { dia: "Sábado", slots: [
    ...
    { dia: "Domingo", slots: [
      ...
      { h: "17h30 - 17h50", o: "Intervalo", status: "intervalo" },
      { h: "17h50 - 19h20", o: "Chef Gabi Barreto + Chef Renata + Jardenia", nota: "Dorigem", patrocinadorLogo: "/patrocinadores/master-dorigem.webp", status: "confirmado" },
      { h: "19h20 - 19h40", o: "Intervalo", status: "intervalo" },
      { h: "19h40 - 22h00", o: "Chef Phelipe Carvalho + Chef Lia Quinderé + Jardenia", nota: "Phelipe Carvalho + Lia Quinderé · Pagueti + Dorigem", patrocinadorLogo: "/patrocinadores/logo-pagueti.webp", receita: "Entrada: amuse de queijo terroir Nossa Santa com prime rib.\nSobremesa: sopa de chocolate com Sucroc e Baniwa.", status: "confirmado" },
    ]},
  ]},
];
