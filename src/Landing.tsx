...
const chefs: { nome: string; sub?: string; casa?: string; atracao: string; dia: string; cor: string; foto?: string; link?: string; instagram?: string; instagram2?: string; bio?: string; pronome?: string; status?: "aconfirmar" }[] = [
  ...
  // SÁBADO
  { link: "/chefs/matu-macedo", pronome: "dela", nome: "Chef Matu Macêdo", sub: "Sabor de uma bela história", atracao: "Palco Gourmet", dia: "SAB", cor: "bg-vinho", foto: "/chefs/matu-macedo.webp", instagram: "https://www.instagram.com/mattumacedo/" },
...
const gradeEspacos: { id: string; nome: string; icon: string; grade: { dia: string; slots: { h: string; o: string; nota?: string; subtitulo?: string; patrocinadorLogo?: string | string[]; tema?: string; receita?: string; status: "confirmado" | "aconfirmar" | "fixo" | "intervalo" }[] }[] }[] = [
  { id: "palco", nome: "Palco Gourmet", icon: "mic", grade: [
    ...
    { dia: "Sábado", slots: [
      ...
      { h: "19h40 - 20h20", o: "Chef Bárbara Saunders", status: "confirmado" },
    ...
    { dia: "Domingo", slots: [
      ...
      { h: "20h00 - 21h00", o: "Chef Elcio e Chef Bia Nagano (Part. DJ Itaque)", nota: "Oficina", patrocinadorLogo: "/brand/logo-sao-luiz-cor.webp", status: "confirmado" },
    ]},
  ]},
  ...
  { id: "casa", nome: "Recebendo em Casa", icon: "home", grade: [
    { dia: "Sexta", slots: [
      ...
      { h: "19h20 - 19h40", o: "Intervalo", status: "intervalo" },
      { h: "19h40 - 22h00", o: "Chef Phelipe Carvalho + Chef Mona Figueiredo ", nota: "Phelipe Carvalho + Mona · Opção", patrocinadorLogo: ["/brand/logo-sao-luiz-cor.webp", "/patrocinadores/master-opcao.webp"], status: "confirmado" },
    ]},
    { dia: "Sábado", slots: [
